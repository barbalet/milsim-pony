...
release_cycle="${RELEASE_CYCLE:-122}"
expected_version="${EXPECTED_MARKETING_VERSION:-1.22.0}"
expected_build="${EXPECTED_BUILD_NUMBER:-122}"
...
release_docs=(
  "README.md"
  "Docs/CYCLE_122_SMOKE_TEST.md"
  "Docs/CYCLE_121_SMOKE_TEST.md"
  "Docs/CYCLE_120_SMOKE_TEST.md"
  "Docs/CYCLE_119_SMOKE_TEST.md"
  "Docs/CYCLE_118_SMOKE_TEST.md"
  "Docs/CYCLE_117_SMOKE_TEST.md"
  "Docs/CYCLE_117_PROFILING_REVIEW.md"
